...
class EzyConnectionFailureHandler {
  handle(event) {
    ...
    var reasonName = _ezyConstants.default.EzyConnectionFailedReasons.getConnectionFailedReasonName(reason);

    _ezyLogger.default.warn('connection failure, reason = ' + reasonName);
