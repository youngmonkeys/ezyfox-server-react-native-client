  ...
  send(cmd, data, encrypted) {
    ...
    if (encrypted && !sessionKey) {
      if (enableDebug) {
        ...
        EzyLogger.error("can not send command: $cmd, you must enable SSL " + "or enable debug mode by configuration when you create the client");
        return;
      }
    }
